...
<div style="margin-left: 130px"><a href=/settings style="alignment: right"
                                   class="fixed inline-block mx-auto bg-gray-200 py-2 px-4 top-3 margin-left-50 rounded-xl text-sm">
...
@foreach($cards as $card)
    <form style="margin-inline: 5%" style="text-align: left"
          class="border rounded-xl border-gray-100 bg-gray-300 p-6 rounded-xl'">
        <article>
            <h1>
                ...
                <button id="editBtn" class="edit editBtn">Edit</button>

                <div id="editModal" class="modal editModal">
                    <div class="modal-content rounded-xl">
                        <br>
                        <div class="modal-header rounded-xl">
                            <span class="close">&times;</span>
                            <h2 style="text-align: center" class="text-xl">Edit card</h2>
                        </div>
                        <div class="modal-body">
                            <form method="POST" action="/cards/{{$card->id}}/edit">
                                ...
                                @if($card->priority==0)
                                    <input type="radio" id="low" name="priority" value="0" style="alignment: left"
                                           checked>
                                      <label for="low" style="font-style: italic" style="color: gray">Low</label>
                                      <input type="radio" id="high" name="priority" value="1">
                                      <label for="high" style="font-style: italic" style="color: gray">High</label><br>
                                    <br>
                                @endif
                                @if($card->priority==1)
                                    <input type="radio" id="low" name="priority" value="0" style="alignment: left">
                                      <label for="low" style="font-style: italic" style="color: gray">Low</label>
                                      <input type="radio" id="high" name="priority" value="1" checked>
                                      <label for="high" style="font-style: italic" style="color: gray">High</label><br>
                                    <br>
                                @endif
                                <input type="hidden" name="list_id" value="{{$list->id}}">
                                <button style="color: #4a5568" class="bg-blue-300 py-2 px-20 text-m w-full rounded-xl"
                                        type="submit" style="font-size:16px">Save</button>
                                <br><br>
                ...
                <script>
                    document.getElementsByClassName("editBtn")[{{$loop->index}}].onclick = function () {
                        document.getElementsByClassName("editModal")[{{$loop->index}}].style.display = "block";
                    };
...
<div style="margin-inline: 5%">
    <button id="myBtn" onclick="createFunction()" style="text-align: center"
            class="rounded-xl bg-blue-200 px-4 py-3 rounded-xl w-full">
        Create new card
    </button>
</div>
    ...
    <div class="modal-content rounded-xl">
        ...
        <div class="modal-body">
            <form method="POST" action="/cards">
                ...
                <input type="hidden" name="list_id" value="{{$list->id}}">
                <input style="color: #4a5568" class="bg-blue-300 py-2 px-20 text-m w-full rounded-xl" type="submit"
                       value="Create" style="font-size:16px">
                <br><br>

...
<br>
<form method="get" action="/edit" style="margin-inline: 20%" style="text-align: left" class="border rounded-xl border-gray-100 bg-gray-300 p-6 rounded-xl'">
    @csrf
    <button href = / class="bg-gray-400  py-3 px-5 text-xl rounded-xl w-full" type="reset" value="" disabled>Edit profile</button><br> <br>
    ...
    <input class=" bg-blue-400 py-2 px-20 text-m rounded-xl w-full" type="submit" value="Save" style="font-size:16px">
    <br>
</form>
